...
const CONTRACT_ADDRESS = '0x29b29099730C9d1811Ee8F2D1513F2d67Ab0314C';
...
const CourseDetailPage = () => {
  ...
  const buyCourse = async () => {
    try {
      ...
      await contract.methods.buyCourse(4).send({ from: account, value: web3.utils.toWei('0.001', 'ether') });
